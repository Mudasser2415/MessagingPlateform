    ...
    <div style={{ display: "grid", gap: "1.5rem" }}>
      <section
        style={{
          ...
          borderRadius: "1rem",
          background:
            "linear-gradient(135deg, rgba(124, 58, 237, 0.12), rgba(15, 23, 42, 0.03))",
      ...
      >
        <div>
          ...
          <p style={{ marginTop: "0.75rem", color: "var(--secondary)" }}>
            Inspect create, update, and delete activity across clients,
            templates, groups, partners, and users.
          </p>
        </div>
