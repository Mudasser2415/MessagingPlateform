        ...
        >
          <div>
            ...
            <p style={{ color: "var(--secondary)", marginTop: "0.35rem" }}>
              Capture the client profile and bind it to a partner record in one
              workflow.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                style={{
                  marginBottom: 0,
                  borderColor: formErrors.businessType ? "#ef4444" : undefined,
                }}
              >
            ...
            <div>
              ...
              <select
                ...
                style={{
                  marginBottom: 0,
                  borderColor: formErrors.partnerId ? "#ef4444" : undefined,
                }}
          ...
          >
            <p style={{ fontSize: "0.8rem", color: "var(--secondary)" }}>
              Client access credentials are provisioned automatically during
              admin creation.
            </p>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Phone size={14} /> {client.mobileNumber}
                      </span>
                      <span
                        style={{
                          display: "flex",
                      ...
                      >
                        <Building2 size={14} /> {client.businessType}
                      </span>
                    </div>
                    ...
                    >
                      ...
                      >
                        <span>{client.groupCount} groups</span>
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ color: "var(--secondary)", marginTop: "0.35rem" }}>
                Review profile, partner ownership, and platform activity.
              </p>
            </div>
